...
tabControl.add(tab1, text='Adult membership Data')
tabControl.add(tab2, text='Child membership data Collection ')
...
def add():
    ...
    if a == "" or b == "" or c == "" or d == "" or e == "" or f == "" or g == "" or h == "":
        ...
        con = mysql.connect(host="localhost", user="root", password="REGSQL45", database="church")
        cursor = con.cursor()
        cursor.execute(
...
view_all=Button(tab1,text="View all",font="bold",fg="black",bg="lightyellow",borderwidth=5,command=show)
view_all.place(x=970,y=280,height=60,width=130)

search=Button(tab1,text="Search Entry",font="bold",fg="black",bg="lightyellow",borderwidth=5,command=search)
search.place(x=970,y=345,height=60,width=130)

add_entry=Button(tab1,text="Add Entry",font="bold",fg="black",bg="lightyellow",borderwidth=5,command=add)
add_entry.place(x=970,y=410,height=60,width=130)


update=Button(tab1,text="Update",font="bold",fg="black",bg="lightyellow",command=update)
update.place(x=970,y=475,height=60,width=130)


delete=Button(tab1,text="Delete",font="bold",fg="black",bg="lightyellow",command=delete)
delete.place(x=970,y=540,height=60,width=130)

close=Button(tab1,text="Close",font="bold",fg="black",bg="lightyellow",command=root.destroy)
close.place(x=970,y=605,height=60,width=130)

clear=Button(tab1,text="Clear Entries",font="bold",fg="black",bg="lightyellow",command=clear)
clear.place(x=970,y=670,height=60,width=130)

my_img=ImageTk.PhotoImage(Image.open("img1.png").resize((500,450)))
my_label=Label(tab1,image=my_img)
my_label.place(x=1110,y=0,height=680,width=680)

display=Label(tab1,font=('arial',20,'bold'),fg='dark blue')
display.place(x=0,y=600,height=40,width=680)
tick()
show()
root.mainloop()