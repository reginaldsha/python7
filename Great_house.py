...
label_0=Label(root,text="ID",font=('ariel 15 bold'),fg="blue")
label_0.place(x=0,y=40,width=150,height=20)
entry_0=Entry(root,borderwidth=4)
...
view_all=Button(root,text="View all",font="bold",fg="black",bg="lightyellow",borderwidth=5,command=show)
view_all.place(x=970,y=280,height=60,width=130)

search=Button(root,text="Search Entry",font="bold",fg="black",bg="lightyellow",borderwidth=5,command=search)
search.place(x=970,y=345,height=60,width=130)

add_entry=Button(root,text="Add Entry",font="bold",fg="black",bg="lightyellow",borderwidth=5,command=add)
add_entry.place(x=970,y=410,height=60,width=130)


update=Button(root,text="Update",font="bold",fg="black",bg="lightyellow",command=update)
update.place(x=970,y=475,height=60,width=130)


delete=Button(root,text="Delete",font="bold",fg="black",bg="lightyellow",command=delete)
delete.place(x=970,y=540,height=60,width=130)

close=Button(root,text="Close",font="bold",fg="black",bg="lightyellow",command=root.destroy)
close.place(x=970,y=605,height=60,width=130)

clear=Button(root,text="Clear Entries",font="bold",fg="black",bg="lightyellow",command=clear)
...
display=Label(root,font=('arial',20,'bold'),fg='dark blue')
